...
Then one should wonder if the \mono{Inlined} 
...
Contrary to the design principle of the 3 stage compiler (\cref{section:background:core_lang}), where the Core transformation middlesection
