...
\begin{itemize}
  ...
  \item \textbf{View} - The way the state is rendered: \mono{view: Model -> Html Msg}. The \mono{Html} type is polymorphic over the \mono{Msg} so that it can contain sound event emitters like \mono{onClick}.
\end{itemize}
