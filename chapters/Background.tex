...
of type \mono{a -> b -> b} and \mono{b} (previously \mono{:} and \mono{[]}):
...
\mono{build} is the antithesis of \mono{foldr} such that the following holds:
...
We can see all some these functions at work when looking at the definition of \mono{unlines} and its subsequent
...
Because the list \text{ls} is the input of the function we cannot remove it all together, but keep in mind that when inlining this function
